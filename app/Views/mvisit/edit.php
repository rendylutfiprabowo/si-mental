                    ...
                    <tr>
                        <td>
                            <div class="form-group mb-3">
                                ...
                                <input type="text" name="nomor_jastel" class="form-control" id="nomor_jastel" readonly value="<?= $ctb[0]['nomor_jastel'] ?>">
                            </div>
                        </td>
                        <td>
                            <div class="form-group mb-3">
                                <label for="nama">Nama Pelanggan</label>
                                <input type="text" name="nama" id="disabledTextInput" class="form-control" id="nama" readonly value="<?= $ctb[0]['nama'] ?>">
                            </div>
                        </td>
                    </tr>
                    <tr>
                        <td>
                            <div class="form-group mb-3">
                                ...
                                <input type="tel" name="contact" class="form-control" style="background-color: white;" id="contact" value="<?= $ctb[0]['contact'] ?>">
                            </div>
                        </td>
                        <td>
                            <div class="form-group mb-3">
